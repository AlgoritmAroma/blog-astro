// Mirror of apps/blog/src/lib/cover-frame.ts, kept in step by hand the same
// way lib/db.ts is. The editor's "как будет на сайте" panel is only honest
// while the two agree — if you change the band here, change it there.
/**
